...
ctypes.windll.kernel32.SetConsoleTitleW(f"『 SOLORAID 』 By ~SOLORAID~ / Tokens: {lol} ")

def Server_Joiner_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 SOLORAID 』 By ~SOLORAID~ / Tokens: {lol} | Joined : {Joined}")
...
def Token_Checker_title():
    ...
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 SOLORAID 』 By ~SOLORAID~ / Tokens: {lol} | Tokens Checked : {Token_checked} ~ Valid Tokens : {valid_tokens} ~ Verified Tokens: {verified_tokens} ~ Nitro Tokens : {Tokens_withnitro}")

def Server_Spammer_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 SOLORAID 』 By ~SOLORAID~ / Tokens: {lol} | Messages Send : {Message_send}")

def Webhook_Deleter_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 SOLORAID 』 By ~SOLORAID~ / Tokens: {lol} | Webhooks Deleted : {Deleted}")
...
def VC_joiner_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 SOLORAID 』 By ~SOLORAID~ / Tokens: {lol} | Vc Joined : {vc_joined}")

def Pfp_Changer_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 SOLORAID 』 By ~SOLORAID~ / Tokens: {lol} | Pfp Changed : {pfp_changed}")
...
def Nickname__bio_Changer_title():
    ...
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 SOLORAID 』 By ~SOLORAID~ / Tokens: {lol} | Nicknames Changed : {nickname_changed} ~ Bios Changed : {bio_changed}")
...
def SOLORAID():
    ...
    Write.Print(f'''
                                ...
                                /\  ___\   /\  ___\   /\ \       /\  ___\   
                                \ \ \____  \ \  __\   \ \ \____  \ \___  \          ║ Tokens > {lol}
                                \ \ \____  \ \  __\   \ \ \____  \ \___  \          ║ Proxies > {proxies}
                                ...
                                \/_____/   \/_____/   \/_____/   \/_____/           
                                       ...
                                       by ~SOLORAID~ | https://discord.gg/UGJy2VY85e
════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════                  
    ...
    , Colors.red_to_blue, interval=0.000)
    choice = input(f""" {blue}
┌──{red}(SOLORAID@skid){blue} ~ [{red}Ϟ{blue}]
└─> """)
    threads = []
    session = check_useproxies()
